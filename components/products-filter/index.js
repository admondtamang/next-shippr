...
const ProductsFilter = () => {
  ...
  return (
    <form
      className="products-filter md:sticky md:top-24"
    ...
    >
      ...
      >
        ...
        <div className="products-filter__block">
          ...
          <div className="products-filter__block__content checkbox-square-wrapper flex">
        ...
        {/* <div className="products-filter__block">
          ...
          <div className="products-filter__block__content">
            <div className="checkbox-color-wrapper flex">
